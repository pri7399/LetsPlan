...
The foundation of this project is built on top of the retirement planning framework explained by **Ankur Warikoo** in his video **"Plan Your RETIREMENT with an EXCEL Sheet"**. His clear, step-by-step approach to retirement planning using an Excel sheet served as the base for this tool. Full credit to him for the core methodology and financial logic.

That said, this project goes well beyond the original spreadsheet — **I've added several advanced features like Coast FIRE modeling, real estate tracking, multi-phase investment strategies, lifetime event planning, visual projections and export options to make it a more comprehensive planning tool**
...
- Responsive design (mobile to laptop to monitor)
...
**Earning Phase:**
```
Ending = Starting x (1 + Return) + Annual_Investment + Windfalls - Withdrawals
```

**Coast Phase:**
```
Ending = Starting x (1 + Coast_Return)
```

**Withdrawal Phase:**
```
Ending = Starting x (1 + Retired_Return) - Inflated_Expenses
```

**Real Estate:**
```
Property_Value = Initial_Value x (1.05)^Years_Held
```

**Blended Returns:**
```
Blended = Sum(Fund_Return x Fund_Share) - 2%
```

### Default Configuration
- Current Age: 28 | Retirement: 46 | Life Expectancy: 80
- Current Savings: Rs 8L | Monthly SIP: Rs 40K | Step-up: 5%
- Coast Period: 7 years (age 46-53)
- Retirement Expenses: Rs 1L/month | Inflation: 6%
